...
public class Buscar extends AppCompatActivity implements LoaderManager.LoaderCallbacks<String> {
    ...
    public void BuscaFilmes(View view) {
        ...
        if (networkInfo != null && networkInfo.isConnected()
            ...
            generos.setText(R.string.loading);
        }
        // atualiza a textview para informar que não há conexão ou termo de busca
        else {
            if (queryString.length() == 0) {
                generos.setText(R.string.str_empty);
                generos.setText(R.string.no_search_term);
            } else {
                generos.setText(" ");
                generos.setText(R.string.no_network);
            }
        }
    }
